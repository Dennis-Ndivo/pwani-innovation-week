      ...
      <div className="section-container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/hackathon" className="text-gray-300 hover:text-[#F97316] transition-colors">Hackathon</Link>
              </li>
              <li>
        ...
        <div className="container mx-auto px-4">
          <div className="md:flex md:items-center md:justify-between text-sm">
            ...
            <div className="mt-4 md:mt-0 text-center md:text-right">
              <p className="text-gray-400">Organized by Swahilipot Hub Foundation</p>
            </div>
          </div>
        </div>
      </div>
